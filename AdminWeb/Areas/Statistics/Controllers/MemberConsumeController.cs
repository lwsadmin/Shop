...
{
    public class MemberConsumeController : AdminBaseController
    {
        ...
        public ActionResult List(int id = 1)
        {
            ...
            string table = string.Format(@"(select n.*,c.Name,m.Mobile,m.CardID,m.NickName from TMemberConsumeNote n
left join TMember m on n.MemberGuid=m.Guid
left join TChainStore c on n.ChainStoreGuid=c.Guid)tab");
            int PageSize = 10;
